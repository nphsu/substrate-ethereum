...
/// Used for the module template in `./nft.rs`
mod nft;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("substrate-chain"),
	impl_name: create_runtime_str!("substrate-chain"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
