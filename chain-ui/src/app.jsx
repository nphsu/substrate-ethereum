...
class NFTItemSegment extends React.Component {
	constructor() {
		super()
		...
		return <Segment style={{ margin: '1em' }} padded>
			<Header as='h2'>
				...
				<Header.Content>
					NFT Item
					<Header.Subheader>
						<Pretty value={runtime.nft.allItemCount} />
					</Header.Subheader>
				</Header.Content>
			</Header>
			<SignerBond bond={this.account} />
			<TransactButton content="Create Item" icon='paw' tx={{ sender: runtime.indices.tryIndex(this.account), call: calls.nft.createItem() }} />
		</Segment>
	}
}
